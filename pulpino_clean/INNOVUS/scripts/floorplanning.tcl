...
set CORE_LOGIC pulpino_top_inst/accel_instance_i_accel_wrapper_inst_ram_inst_dp_ram_i
...
### Place memory macros
create_relative_floorplan -place $CORE_LOGIC  -ref_type core_boundary -horizontal_edge_separate "3 0 3" -vertical_edge_separate "2 0 2" -orient R0
...
### Add placement halo
addHaloToBlock 20 0 0 20 $CORE_LOGIC
